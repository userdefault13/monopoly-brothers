...
import { goToJail } from "../../cards/corners/goToJail";

const squareTileWidth = 240;
const squareTileHeight = 240;

export default class GoToJailTile extends BaseTile {
    constructor(goToJailConfig) {
        super(squareTileWidth, squareTileHeight);
        const { index, name, action} = goToJailConfig;
        this.index = index;
        this.name = name;
        this.action = action;
    }
